    ...
    <header className="d-flex px-5 py-4 justify-content-between align-items-center header">
        ...
        <nav className="main-nav">
            <ul className="d-flex justify-content-between align-items-center ps-0 mb-0">
                <li className="list-group-item"><a className="text-decoration-none link" href="#">About</a></li>
                <li className="list-group-item"><a className="text-decoration-none link" href="#">Services</a></li>
                <li className="list-group-item"><a className="text-decoration-none link" href="#">Projects</a></li>
